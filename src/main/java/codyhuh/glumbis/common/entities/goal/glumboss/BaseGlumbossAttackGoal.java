...
public class BaseGlumbossAttackGoal extends Goal {
    ...
    public BaseGlumbossAttackGoal(Glumboss glumboss, int timerEnd, int coolDownEnd, int animation, int frameStart, int frameEnd, boolean shouldStopMoving, float range) {
