...
public class GlumbossLightningStrikeGoal extends BaseGlumbossAttackGoal {
    ...
    public GlumbossLightningStrikeGoal(Glumboss glumboss, int timerEnd, int coolDownEnd, int animation, int frameStart, int frameEnd, boolean shouldStopMoving, float range) {
